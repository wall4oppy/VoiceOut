    ...
    return (
        <div className="w-full bg-background" style={{ minHeight: "calc(100vh - 3.5rem)" }}>
            <div className="w-full grid lg:grid-cols-5" style={{ minHeight: "calc(100vh - 3.5rem)" }}>
                ...
                {/* Login Form Side - 60% */}
                <div className="col-span-1 lg:col-span-3 p-6 lg:p-12 flex flex-col justify-center h-full overflow-y-auto">
                    <div className="w-full max-w-md mx-auto space-y-8">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-muted-foreground mt-2">登入 VoiceOut 以繼續</p>

                            {selectedRole && (
                                <div className="mt-4 p-3 bg-primary/10 rounded-lg flex items-center justify-between text-left">
                        ...
                        <div className="mt-6">
                            <div className="relative">
                                ...
                                <div className="relative flex justify-center text-sm">
                                    <span className="px-4 bg-background text-muted-foreground">或使用</span>
                                </div>
                            </div>
                            ...
                            <div className="mt-8">
                                <div className="relative mb-4">
                                    ...
                                    <div className="relative flex justify-center text-sm">
                                        <span className="px-4 bg-background text-muted-foreground">測試帳號快速登入</span>
                                    </div>
                                </div>
                                <div className="grid grid-cols-2 gap-2">
                                    {/* Keep existing mapping logic but ensure testUsers is in scope - it is */}
